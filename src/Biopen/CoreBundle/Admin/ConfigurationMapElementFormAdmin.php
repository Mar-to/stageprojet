    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper            
            ->with("Contenu de la Fiche détail (panneau qui s'affiche lors d'un click sur un marker)",
                ...
                ->add('infobar.headerTemplateUseMarkdown', 'checkbox', array('label' => 'Utiliser la syntaxe markdown pour le header (sinon uniquement Twig)', 'attr' => ['class' => 'use-markdown'], 'required' => false))
                ...
                ->add('infobar.bodyTemplateUseMarkdown', 'checkbox', array('label' => 'Utiliser la syntaxe markdown pour le body (sinon uniquement Twig)', 'attr' => ['class' => 'use-markdown'], 'required' => false))
