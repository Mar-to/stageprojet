...
class ConfigurationStyleAdmin extends ConfigurationAbstractAdmin
{
    ...
    {
        $formMapper
            ->panel('Thème et polices', ['class' => 'col-md-6'])
            ...
            ->end()
            ->panel('Couleurs principales', ['class' => 'col-md-6'])
            ...
            ->end()
            ->panel("Charger d'autres polices et icones")
            ...
            ->end()
            ->panel('Autres couleurs', ['class' => 'col-md-6'])
            ...
            ->end()
            ->panel('Couleurs avancées', ['class' => 'col-md-6'])
