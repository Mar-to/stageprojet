...
class ConfigurationMenuAdmin extends ConfigurationAbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->tab('Général')
                ->panel('Menu (contient les filtre et la barre de recherche)')
            ...
            ->tab('Recherche')
                ...
                ->end()
                ->panel('Champs à utiliser pour chercher dans les élements', ['description' => "Pour choisir les champs de recherche, allez dans le formulaire, éditer un des champs et vous verrez apparaître l'option \"Recherche dans ce champ\". Vous pouvez aussi assigner des poids différents sur chaque champs, les poids seront utilisés pour classer les résultats par pertinence."])
                ->end()
            ->end()
        ;
    }
