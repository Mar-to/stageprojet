...
class ConfigurationMobileAdmin extends ConfigurationAbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->end()
            ->panel('Vrai application mobile (Trusted Web Activity)', ['description' => 'Cette fonctionalité est en cours de test, merci de patienter pour de future explications'])
