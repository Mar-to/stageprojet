...
{
   protected $baseRouteName = 'admin_gogo_geodirectory_category_lite';
	protected $baseRoutePattern = 'admin_gogo_geodirectory_category_lite';
	...
	protected function configureFormFields(FormMapper $formMapper)
	{
	  $formMapper
         ...
         ->add('displayInForm', null, array('required' => false, 'label' => "Formulaire"))
		  	->add('_link', 'text', array('required' => false, 'mapped'=>false, 'label' => 'admin_gogo_geodirectory_category_edit'));
	}
}