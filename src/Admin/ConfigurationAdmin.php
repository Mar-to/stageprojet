...
class ConfigurationAdmin extends ConfigurationAbstractAdmin
{
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->end()
            ->with('Nom des entités référencées sur l\'annuaire pour le 2eme formulaire', ['class' => 'col-md-6'])
                ->add('elementDisplayName2', null, ['label' => 'Nom'])
                ->add('elementDisplayNameDefinite2', null, ['label' => 'Nom avec article défini'])
                ->add('elementDisplayNameIndefinite2', null, ['label' => 'Nom avec article indéfini'])
                ->add('elementDisplayNamePlural2', null, ['label' => 'Nom pluriel '])
            ->end()
