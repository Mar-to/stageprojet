import { BingProvider, ChainProvider, ChainProviderOptionsInterface, GeoPluginProvider, GoogleMapsProvider, GoogleMapsProviderOptionsInterface, MapboxProvider, MapboxProviderOptionsInterface, MapquestProvider, NominatimProvider, NominatimProviderOptionsInterface, OpenCageProvider, OpenCageProviderOptionsInterface, YandexProvider, YandexProviderOptionsInterface, ProviderOptionsInterface } from "./provider";
interface ProviderOptionInterface {
    provider: "bing" | "chain" | "geoplugin" | "google" | "googlemaps" | "mapbox" | "mapquest" | "nominatim" | "opencage" | "openstreetmap" | "yandex";
}
...
interface GeoPluginGeocoderProviderFactoryOptions extends ProviderOptionInterface {
    provider: "geoplugin";
}
...
export declare type GeocoderProviderFactoryOptions = ProviderFactoryOptions | ChainGeocoderProviderFactoryOptions | GeoPluginGeocoderProviderFactoryOptions | GoogleMapsGeocoderProviderFactoryOptions | MapboxGeocoderProviderFactoryOptions | NominatimGeocoderProviderFactoryOptions | OpenCageGeocoderProviderFactoryOptions | YandexGeocoderProviderFactoryOptions;
export declare type GeocoderProvider = BingProvider | ChainProvider | GeoPluginProvider | GoogleMapsProvider | MapboxProvider | MapquestProvider | NominatimProvider | OpenCageProvider | YandexProvider;
