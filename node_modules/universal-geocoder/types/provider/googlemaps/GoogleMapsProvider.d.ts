...
export default class GoogleMapsProvider implements ProviderInterface<GoogleMapsGeocoded> {
    ...
    geodecode(latitudeOrQuery: number | string | GoogleMapsReverseQuery | GoogleMapsReverseQueryObject, longitudeOrCallback: number | string | GoogleMapsGeocodedResultsCallback, callbackOrErrorCallback?: GoogleMapsGeocodedResultsCallback | ErrorCallback, errorCallback?: ErrorCallback): void;
