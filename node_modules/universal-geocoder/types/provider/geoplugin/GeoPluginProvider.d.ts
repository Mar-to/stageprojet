...
export default class GeoPluginProvider implements ProviderInterface<GeoPluginGeocoded> {
    ...
    geocode(query: string | GeocodeQuery | GeocodeQueryObject, callback: GeoPluginGeocodedResultsCallback, errorCallback?: ErrorCallback): void;
    geodecode(latitudeOrQuery: number | string | ReverseQuery | ReverseQueryObject, longitudeOrCallback: number | string | GeoPluginGeocodedResultsCallback, callbackOrErrorCallback?: GeoPluginGeocodedResultsCallback | ErrorCallback, errorCallback?: ErrorCallback): void;
