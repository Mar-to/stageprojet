...
export default class MapboxProvider implements ProviderInterface<MapboxGeocoded> {
    ...
    geodecode(latitudeOrQuery: number | string | MapboxReverseQuery | MapboxReverseQueryObject, longitudeOrCallback: number | string | MapboxGeocodedResultsCallback, callbackOrErrorCallback?: MapboxGeocodedResultsCallback | ErrorCallback, errorCallback?: ErrorCallback): void;
