...
export default class GoogleMapsProvider implements ProviderInterface<GoogleMapsGeocoded> {
    ...
    geocode(query: string | GoogleMapsGeocodeQuery | GoogleMapsGeocodeQueryObject, callback?: GoogleMapsGeocodedResultsCallback, errorCallback?: ErrorCallback): void | Promise<GoogleMapsGeocoded[]>;
    geodecode(latitudeOrQuery: number | string | GoogleMapsReverseQuery | GoogleMapsReverseQueryObject, longitudeOrCallback?: number | string | GoogleMapsGeocodedResultsCallback, callbackOrErrorCallback?: GoogleMapsGeocodedResultsCallback | ErrorCallback, errorCallback?: ErrorCallback): void | Promise<GoogleMapsGeocoded[]>;
