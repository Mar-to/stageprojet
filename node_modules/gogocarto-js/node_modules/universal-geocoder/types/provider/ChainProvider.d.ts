...
export default class ChainProvider implements ProviderInterface<Geocoded> {
    ...
    geocode(query: string | GeocodeQuery | GeocodeQueryObject, callback?: ChainGeocodedResultsCallback, errorCallback?: ErrorCallback): void | Promise<Geocoded[]>;
    geodecode(latitudeOrQuery: number | string | ReverseQuery | ReverseQueryObject, longitudeOrCallback?: number | string | ChainGeocodedResultsCallback, callbackOrErrorCallback?: ChainGeocodedResultsCallback | ErrorCallback, errorCallback?: ErrorCallback): void | Promise<Geocoded[]>;
