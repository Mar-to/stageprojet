...
exports.defaultYandexProviderOptions = void 0;
var provider_1 = require("./..");
var AdminLevel_1 = __importDefault(require("../../AdminLevel"));
var utils_1 = require("../../utils");
exports.defaultYandexProviderOptions = __assign(__assign({}, provider_1.defaultProviderOptions), { apiKey: "" });
var YandexProvider = /** @class */ (function () {
    function YandexProvider(_externalLoader, options) {
        if (options === void 0) { options = exports.defaultYandexProviderOptions; }
        this.externalLoader = _externalLoader;
        this.options = __assign(__assign({}, exports.defaultYandexProviderOptions), options);
    ...
    YandexProvider.prototype.geocode = function (query, callback, errorCallback) {
        ...
        var geocodeQuery = provider_1.ProviderHelpers.getGeocodeQueryFromParameter(query, provider_1.YandexGeocodeQuery);
    ...
    YandexProvider.prototype.geodecode = function (latitudeOrQuery, longitudeOrCallback, callbackOrErrorCallback, errorCallback) {
        var _this = this;
        var _a;
        var reverseQuery = provider_1.ProviderHelpers.getReverseQueryFromParameters(latitudeOrQuery, longitudeOrCallback, provider_1.YandexReverseQuery);
    ...
    YandexProvider.mapToGeocoded = function (result) {
        ...
        var addressDetails = utils_1.flattenObject(result.metaDataProperty.GeocoderMetaData.AddressDetails);
        ...
        var geocoded = provider_1.YandexGeocoded.create({
            coordinates: {
                latitude: latitude,
                longitude: longitude,
            },
