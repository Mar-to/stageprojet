...
exports.defaultMapboxProviderOptions = exports.MAPBOX_SOURCES = void 0;
var provider_1 = require("./..");
var AdminLevel_1 = __importStar(require("../../AdminLevel"));
...
})(MAPBOX_SOURCES = exports.MAPBOX_SOURCES || (exports.MAPBOX_SOURCES = {}));
exports.defaultMapboxProviderOptions = __assign(__assign({}, provider_1.defaultProviderOptions), { apiKey: "", source: MAPBOX_SOURCES.SOURCE_PLACES });
            ...
            switch (type) {
                ...
                case "place":
                    ...
                    adminLevels.push(AdminLevel_1.default.create({
                        level: AdminLevel_1.ADMIN_LEVEL_CODES.COUNTY_CODE,
                        name: locality,
                    }));
                    break;
                case "postcode":
                ...
                case "region":
                    ...
                    adminLevels.push(AdminLevel_1.default.create({
                        level: AdminLevel_1.ADMIN_LEVEL_CODES.STATE_CODE,
                        name: region,
                        code: adminLevelCode,
                    }));
                    break;
