...
exports.defaultLocationIQProviderOptions = void 0;
var provider_1 = require("./..");
var AdminLevel_1 = __importDefault(require("../../AdminLevel"));
var error_1 = require("../../error");
exports.defaultLocationIQProviderOptions = __assign(__assign({}, provider_1.defaultProviderOptions), { apiKey: "", source: "locationiq" });
var LocationIQProvider = /** @class */ (function () {
    function LocationIQProvider(_externalLoader, options) {
        if (options === void 0) { options = exports.defaultLocationIQProviderOptions; }
        this.externalLoader = _externalLoader;
        this.options = __assign(__assign({}, exports.defaultLocationIQProviderOptions), options);
    ...
    LocationIQProvider.prototype.geocode = function (query, callback, errorCallback) {
        ...
        var geocodeQuery = provider_1.ProviderHelpers.getGeocodeQueryFromParameter(query, provider_1.LocationIQGeocodeQuery);
    ...
    LocationIQProvider.prototype.geodecode = function (latitudeOrQuery, longitudeOrCallback, callbackOrErrorCallback, errorCallback) {
        var _this = this;
        var _a;
        var reverseQuery = provider_1.ProviderHelpers.getReverseQueryFromParameters(latitudeOrQuery, longitudeOrCallback, provider_1.LocationIQReverseQuery);
    ...
    LocationIQProvider.mapToGeocoded = function (result) {
        ...
        var geocoded = provider_1.LocationIQGeocoded.create({
            coordinates: {
                latitude: latitude,
                longitude: longitude,
            },
...
exports.default = LocationIQProvider;
