...
var ExternalLoader = /** @class */ (function () {
    ...
    ExternalLoader.prototype.executeRequest = function (params, callback, externalLoaderHeaders, body, errorCallback) {
        ...
        var filteredRequestParams = filterUndefinedObjectValues(requestParams);
        ...
        var headers = filterUndefinedObjectValues(externalLoaderHeaders || {});
        fetch(requestUrl.toString(), {
            ...
            if (!response.ok) {
                throw new ResponseError("Received HTTP status code " + response.status + " when attempting geocoding request.", response);
            }
