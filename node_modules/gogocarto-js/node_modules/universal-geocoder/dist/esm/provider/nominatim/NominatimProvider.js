...
import { NominatimGeocoded, NominatimReverseQuery, NominatimGeocodeQuery, ProviderHelpers, defaultProviderOptions, } from "./..";
import AdminLevel from "../../AdminLevel";
import { ResponseError } from "../../error";
export var defaultNominatimProviderOptions = __assign(__assign({}, defaultProviderOptions), { host: "nominatim.openstreetmap.org", userAgent: "" });
var NominatimProvider = /** @class */ (function () {
    ...
    NominatimProvider.prototype.geocode = function (query, callback, errorCallback) {
        ...
        var geocodeQuery = ProviderHelpers.getGeocodeQueryFromParameter(query, NominatimGeocodeQuery);
    ...
    NominatimProvider.prototype.geodecode = function (latitudeOrQuery, longitudeOrCallback, callbackOrErrorCallback, errorCallback) {
        var _this = this;
        var _a;
        var reverseQuery = ProviderHelpers.getReverseQueryFromParameters(latitudeOrQuery, longitudeOrCallback, NominatimReverseQuery);
    ...
    NominatimProvider.mapToGeocoded = function (result) {
        ...
        var geocoded = NominatimGeocoded.create({
            coordinates: {
                latitude: latitude,
                longitude: longitude,
            },
